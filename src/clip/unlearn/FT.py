...
from clip.training.train import *  # is_master, AverageMeter, backward, unwrap_model, etc.
...
def FT(model, data, loss, epoch, optimizer, scaler, scheduler, dist_model, args,
